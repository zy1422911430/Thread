 ...
 * @Version: 1.0
 */
public class CustomThreadPool<Job extends Runnable> implements IThreadPool<Job> {
    ...
    public CustomThreadPool(int num) {
        workerNum = num > DEFAULT_WORKER_NUMBERS ? DEFAULT_WORKER_NUMBERS : num;
